...
namespace CMS_Testing.Tests
{
    ...
    class Personal_Training_Log_Test : Basetest
    {

        /* taking the reference for screenshot for the baseclass*/
        ExtentReports PersonalTrainingLogscreenshot = Basetest.getInstance();        // Declaring Getinstance as screenshot method //
        ...
        public void Tc8(string browsername)        // Creating the method //
        {
            ...
            var lp = new Personal_Training_Log(driver);      // Creating an instance of base page(Personal Training log)
            Thread.Sleep(2000);
            lp.verifyingtraininglog();                  //Calling the base page methods(Verifying Personal_Training_Log)//
            Thread.Sleep(2000);
        ...
        public void screenshotteardown()      //Creating a method for Extent reports //
        {
            ...
            test = extent.CreateTest("<h3>Personal Training Log</h3>").Info("<h3>Test Started in </h3>" + browsername + " " + "and" + " " + methodname);
        ...
        public void exit()
        {
            PersonalTrainingLogscreenshot.Flush();
        }
    }
}